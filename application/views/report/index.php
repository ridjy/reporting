  ...
  <div class="content">
            <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-4">  
                    <a href="<?php echo site_url('reporting/newreport/?d=').date('Y-m-d') ;?>"><button class="btn btn-warning">Aujourd'hui</button></a>               
                  </div>
                  <div class="col-md-4">
                     <form method="GET" action="<?php echo site_url('reporting/newreport') ?>">
